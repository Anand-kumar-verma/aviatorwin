        ...
        <Layout header={false}>
            <Container >
                ...
                <Box className="flex justify-center gap-5 mx-3 mt-2 mb-1">
                    <Typography className="bg-[#E4063A] !p-5 !px-8 grey-300 shadow-xl  rounded-lg">
                        <img src={load} alt="" className="bg-[#E4063A] rounded-xl  w-10" />
                        Lottery
                    </Typography>
                ...
                <Box sx={{ width: '100%' }} >
                    {/* <Box  >
                        <Tabs value={value} onChange={handleChange} className=" !bg-[#E4063A] !p-5 !px-8 !grey-300 !shadow-xl  !rounded-lg" aria-label="basic tabs example" className=" !p-4 !shadow-xl bg-white " >
