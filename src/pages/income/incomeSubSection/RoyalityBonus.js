...
const zubgback = "#E4063A"
const zubgmid = "#E4063A"
const zubgbackgrad = "#E4063A"
function RoyalityBonus() {
    ...
    <Layout>
      ...
      >
        ...
        <div className="no-scrollbar !mb-10 px-2">
          {res?.map((i) => {
            return (
              <div className="!w-full !flex !flex-col  !bg-[#E4063A]  !p-2 !rounded-lg !mt-2">
