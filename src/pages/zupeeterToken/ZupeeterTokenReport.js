...
export default function ZupeeterTokenReport() {
  ...
  return (
    <Layout>
      ...
      >
        <div className="flex  flex-col  w-full items-center bg-[#E4063A] px-2 py-1 rounded-lg mt-3">
        ...
        <div className="flex justify-between w-full items-center bg-[#E4063A] px-2 py-6 rounded-lg mt-3 ">
            ...
            {fk.values.payment_method === "USDT" && (
              <div className="col-span-2 !h-full !w-full flex items-center mt-10 flex-col">
                ...
                <div className="pt-4  gap-2">
                  <p className="!bg-[#A97025] !text-[#0EE6AC] !text-sm px-2">
        ...
        <div className="flex justify-between w-full px-1 pt-2 pb-1">
          ...
          <div>
            <input
              type="text"
              className="   !bg-[#A97025] !text-white !rounded-md px-2 py-1"
              placeholder="Search.."
            />
          </div>
        </div>
