  ...
  return (
    <Layout header={false}>
      <Container >
        ...
        <Box
          sx={{ background: avred1, padding: 1, }}>
          <Stack
            direction="row"
            sx={{
              alignItems: "end",
        ...
        >
          <Stack direction="row" component={NavLink} to="/banks-details">
            ...
            <Stack
              ...
              alignItems="center"
              justifyContent="space-between"
              sx={{ width: "60%", borderLeft: "1px solid black", pl: "5%" }}
            >
              <Typography
                variant="body1"
                color="initial"
        ...
        >
          ...
          >
            ...
            <InputBase
              ...
              sx={{ px: 1, flex: 1, borderLeft: "1px solid #888", color: avred1 }}
        ...
        <Stack direction="row" sx={{ alignItems: "center", margin: "20px" }}>
          <Box component="img" src={withdravalhistory} width={30} sx={{ filter: 'hue-rotate(310deg)' }}></Box>
          <Typography
            variant="body1"
            color="initial"
            sx={{
        ...
        {visibleData?.map((i, index) => {
          return (
            ...
            >
              ...
              >
                <Box>
                  <Typography className="!bg-red-400 !text-white rounded px-2 py-1 ">
                    Withdrawl
                  </Typography>
                </Box>
                <Box
