      ...
      <Container >
        ...
        >
          <Stack direction="row" sx={{ alignItems: "center", mb: "20px" }}>
            <Box component="img" src={payment} width={30} sx={{ filter: 'hue-rotate(307deg)' }}></Box>
            <Typography
              variant="body1"
              color="initial"
              sx={{
        ...
        >
          <Stack direction="row" sx={{ alignItems: "center", mb: "20px" }}>
            <Box component="img" src={user} width={30} sx={{ filter: 'hue-rotate(307deg)' }}></Box>
            <Typography
              variant="body1"
              color="initial"
        ...
        <Stack direction="row" sx={{ alignItems: "center", margin: "20px" }}>
          <Box component="img" src={withdravalhistory} width={30} sx={{ filter: 'hue-rotate(307deg)' }}></Box>
          <Typography
            variant="body1"
            color="initial"
            sx={{
        ...
        {visibleData?.map((i, index) => {
          return (
            ...
            >
              ...
              >
                <Box>
                  <Typography className="!bg-red-400 !text-white rounded px-2 py-1 !flex justify-center">
                    Deposit
                  </Typography>
                </Box>
                <Box
